...
class PerformanceCacheService:
    ...
    def set(self, key: str, value: Any, ttl_seconds: Optional[float] = None) -> None:
        ...
        with self._lock:
            ...
            entry = CacheEntry(value=value, created_at=time.time(), ttl_seconds=float(ttl_seconds))
...
PERFORMANCE_CACHE_CONFIG_SCHEMA = {
    "cache_max_size": {"type": "integer", "default": 1000, "description": "Maximum number of cache entries"},
    "default_ttl_seconds": {
        "type": "integer",
        "default": 300,
