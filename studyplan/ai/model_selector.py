...
class ModelSelector:
    ...
    def _score_model(
        ...
        quality = score_quality(
            model.name,
            tier,
            param_b=model.param_billions,
            quant=model.quant_tag,
            is_instruct=model.is_instruct,
        ...
        total = quality + ram_score + perf_score
        rationale = (
            f"tier={tier}; purpose={purpose}; quality={quality:.2f}; "
