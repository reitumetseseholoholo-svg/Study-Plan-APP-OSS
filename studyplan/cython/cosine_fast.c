...
#define __PYX_HAVE__cosine_fast
#define __PYX_HAVE_API__cosine_fast
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "cosine_fast" */
static double __pyx_f_11cosine_fast_cosine_similarity(PyObject *, PyObject *, int __pyx_skip_dispatch); /*proto*/
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "cosine_fast"
extern int __pyx_module_is_main_cosine_fast;
int __pyx_module_is_main_cosine_fast = 0;

/* Implementation of "cosine_fast" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
static const char __pyx_k_Cython_accelerated_cosine_simila[] = "Cython-accelerated cosine similarity for dense embedding vectors.\n\nCompile with: cythonize -i studyplan/cython/cosine_fast.pyx\n";
/* #### Code section: decls ### */
static PyObject *__pyx_pf_11cosine_fast_cosine_similarity(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_a, PyObject *__pyx_v_b); /* proto */
...
#define __pyx_kp_u_cosine_fast_pyx __pyx_string_tab[3]
#define __pyx_n_u_Pyx_PyDict_NextRef __pyx_string_tab[4]
#define __pyx_n_u_a __pyx_string_tab[5]
#define __pyx_n_u_asyncio_coroutines __pyx_string_tab[6]
#define __pyx_n_u_b __pyx_string_tab[7]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[8]
#define __pyx_n_u_cosine_fast __pyx_string_tab[9]
#define __pyx_n_u_cosine_similarity __pyx_string_tab[10]
...
#define __pyx_n_u_test __pyx_string_tab[21]
#define __pyx_n_u_values __pyx_string_tab[22]
#define __pyx_kp_b_iso88591_a_nN_t2S_A_q_1A_s_3b_Cq_r_A_q_U __pyx_string_tab[23]
...
static PyObject *__pyx_pw_11cosine_fast_1cosine_similarity(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static double __pyx_f_11cosine_fast_cosine_similarity(PyObject *__pyx_v_a, PyObject *__pyx_v_b, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_n;
  int __pyx_v_i;
  double __pyx_v_dot;
  double __pyx_v_norm_a;
  double __pyx_v_norm_b;
  double __pyx_v_va;
  double __pyx_v_vb;
  double __pyx_r;
  int __pyx_t_1;
 ...
 * 
*/
  if (__pyx_v_a == Py_None) __pyx_t_2 = 0;
  else
  {
    Py_ssize_t __pyx_temp = __Pyx_PyList_GET_SIZE(__pyx_v_a);
    if (unlikely(((!CYTHON_ASSUME_SAFE_SIZE) && __pyx_temp < 0))) __PYX_ERR(0, 19, __pyx_L1_error)
  ...
  if (__pyx_v_b == Py_None) __pyx_t_3 = 0;
  else
  {
    Py_ssize_t __pyx_temp = __Pyx_PyList_GET_SIZE(__pyx_v_b);
    if (unlikely(((!CYTHON_ASSUME_SAFE_SIZE) && __pyx_temp < 0))) __PYX_ERR(0, 19, __pyx_L1_error)
...
*/
  ...
  __pyx_t_4 = __Pyx_PyList_GET_SIZE(__pyx_v_a); if (unlikely(__pyx_t_4 == ((Py_ssize_t)-1))) __PYX_ERR(0, 22, __pyx_L1_error)
  __pyx_v_n = __pyx_t_4;
...
*/
  ...
  __pyx_t_4 = __Pyx_PyList_GET_SIZE(__pyx_v_b); if (unlikely(__pyx_t_4 == ((Py_ssize_t)-1))) __PYX_ERR(0, 23, __pyx_L1_error)
  __pyx_t_1 = (__pyx_t_4 < __pyx_v_n);
  if (__pyx_t_1) {
...
*/
    ...
    __pyx_t_4 = __Pyx_PyList_GET_SIZE(__pyx_v_b); if (unlikely(__pyx_t_4 == ((Py_ssize_t)-1))) __PYX_ERR(0, 24, __pyx_L1_error)
    __pyx_v_n = __pyx_t_4;
...
*/
    ...
    __pyx_t_8 = __Pyx_PyFloat_AsDouble(__Pyx_PyList_GET_ITEM(__pyx_v_a, __pyx_v_i)); if (unlikely((__pyx_t_8 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 29, __pyx_L1_error)
    __pyx_v_va = ((double)__pyx_t_8);
...
*/
    ...
    __pyx_t_8 = __Pyx_PyFloat_AsDouble(__Pyx_PyList_GET_ITEM(__pyx_v_b, __pyx_v_i)); if (unlikely((__pyx_t_8 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 30, __pyx_L1_error)
    __pyx_v_vb = ((double)__pyx_t_8);
 ...
 *         norm_b += vb * vb
*/
    __pyx_v_dot = (__pyx_v_dot + (__pyx_v_va * __pyx_v_vb));
 ...
 * 
*/
    __pyx_v_norm_a = (__pyx_v_norm_a + (__pyx_v_va * __pyx_v_va));
...
*/
    __pyx_v_norm_b = (__pyx_v_norm_b + (__pyx_v_vb * __pyx_v_vb));
  }
 ...
 * 
*/
  __pyx_t_2 = (__pyx_v_norm_a <= 0.0);
  if (!__pyx_t_2) {
  } else {
    __pyx_t_1 = __pyx_t_2;
    goto __pyx_L11_bool_binop_done;
  }
  __pyx_t_2 = (__pyx_v_norm_b <= 0.0);
  __pyx_t_1 = __pyx_t_2;
 ...
 *     return dot / (norm_a ** 0.5 * norm_b ** 0.5)             # <<<<<<<<<<<<<<
*/
  __pyx_t_8 = __Pyx_SoftComplexToDouble(__Pyx_c_quot_double(__pyx_t_double_complex_from_parts(__pyx_v_dot, 0), __Pyx_c_prod_double(__Pyx_c_pow_double(__pyx_t_double_complex_from_parts(__pyx_v_norm_a, 0), __pyx_t_double_complex_from_parts(0.5, 0)), __Pyx_c_pow_double(__pyx_t_double_complex_from_parts(__pyx_v_norm_b, 0), __pyx_t_double_complex_from_parts(0.5, 0)))), 0); if (unlikely(__pyx_t_8 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 38, __pyx_L1_error)
  __pyx_r = __pyx_t_8;
  goto __pyx_L0;
...
*/
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("cosine_fast.cosine_similarity", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  return __pyx_r;
}
...
PyDoc_STRVAR(__pyx_doc_11cosine_fast_cosine_similarity, "Compute cosine similarity between two dense vectors.\n\n    Returns a float in [-1, 1] or 0.0 on edge cases.\n    ");
static PyMethodDef __pyx_mdef_11cosine_fast_1cosine_similarity = {"cosine_similarity", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_11cosine_fast_1cosine_similarity, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_11cosine_fast_cosine_similarity};
static PyObject *__pyx_pw_11cosine_fast_1cosine_similarity(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "cosine_similarity", 0) < (0)) __PYX_ERR(0, 10, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("cosine_similarity", 1, 2, 2, i); __PYX_ERR(0, 10, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("cosine_similarity", 1, 2, 2, __pyx_nargs); __PYX_ERR(0, 10, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_a), (&PyList_Type), 1, "a", 1))) __PYX_ERR(0, 10, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_b), (&PyList_Type), 1, "b", 1))) __PYX_ERR(0, 10, __pyx_L1_error)
  __pyx_r = __pyx_pf_11cosine_fast_cosine_similarity(__pyx_self, __pyx_v_a, __pyx_v_b);
...
static PyObject *__pyx_pf_11cosine_fast_cosine_similarity(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_a, PyObject *__pyx_v_b) {
  ...
  __pyx_t_1 = __pyx_f_11cosine_fast_cosine_similarity(__pyx_v_a, __pyx_v_b, 1); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L1_error)
...
static int __pyx_pymod_exec_cosine_fast(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cosine_fast},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
namespace {
  ...
  #endif
  {
      ...
      "cosine_fast",
      __pyx_k_Cython_accelerated_cosine_simila, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
...
__Pyx_PyMODINIT_FUNC PyInit_cosine_fast(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cosine_fast(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cosine_fast(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cosine_fast' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "cosine_fast" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_cosine_fast", 0);
  ...
  if (__pyx_module_is_main_cosine_fast) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cosine_fast")) {
      if (unlikely((PyDict_SetItemString(modules, "cosine_fast", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 * 
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_11cosine_fast_1cosine_similarity, 0, __pyx_mstate_global->__pyx_n_u_cosine_similarity, NULL, __pyx_mstate_global->__pyx_n_u_cosine_fast, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_cosine_similarity, __pyx_t_2) < (0)) __PYX_ERR(0, 10, __pyx_L1_error)
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("