...
class PerformanceIntegration:
    ...
    def cache_method(self, cache_key_prefix: str = "", ttl_minutes: int = 5):
        ...
        def decorator(func: F) -> F:
            def wrapper(*args, **kwargs):
                ...
                self._cache_service.set(cache_key, result, ttl_seconds=ttl_minutes * 60)
    ...
    def get_performance_stats(self) -> Dict[str, Any]:
        ...
        stats = {"initialized": self._initialized, "cache_service": None, "profiler": None, "middleware": None}
        ...
        if self._middleware:
            stats["middleware"] = {"cache_service_enabled": self._middleware.cache is not None}
